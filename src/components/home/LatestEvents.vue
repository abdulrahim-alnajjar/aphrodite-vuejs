<template>
  <div class="latest-events">
    <div class="container">
      <h2 class="main-head">lastest events</h2>
      <div class="grid">
        <div class="side-box">
          <div class="head">
            <h4>new</h4>
          </div>
          <div v-for="(post, i) in sideBoxData" :key="i" class="post-brief">
            <p v-html="textLength(post.text, 100)"></p>
            <div class="post-info">
              <div class="date" :data-date="post.date">
                {{ calcPostDate(post.date) }}
              </div>
              <div class="actions">
                <a class="comments" href="">
                  <span class="comment-count">{{ post.commentsCounter }}</span>
                  <svg
                    class="icon"
                ...
                ><a class="share" href="">
                  <span class="share-count">{{ post.shareCounter }}</span>
                  <svg
                    class="icon"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 576 512"
        ...
        <div v-for="(post, i) in squareBoxData" :key="++i" class="square-box">
          <img :src="post.imgUrl" alt="" />
          <div class="post-brief">
            <p v-html="textLength(post.text, 100)"></p>
            <div class="post-info">
              <div class="date" v-text="calcPostDate(post.date)"></div>
              <div class="actions">
                <a class="comments" href=""
                  ><span
                    class="comment-count"
                    v-text="post.commentsCounter"
                  ></span>
                  <svg
                    class="icon"
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  >
                    ...
                    /></svg></a
                ><a class="share" href=""
                  ><span class="share-count" v-text="post.shareCounter"></span>
                  <svg
                    class="icon"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 576 512"
    ...
    return {
      ...
      squareBoxData: [
        ...
        },
        {
          ...
          commentsCounter: 42,
          shareCounter: 13,
          imgUrl: "https://picsum.photos/510/300",
        },
        {
          id: 3,
          date: "6/12/2022",
        ...
        },
        {
          ...
          commentsCounter: 64,
          shareCounter: 88,
          imgUrl: "https://picsum.photos/530/300",
        },
      ],
    };
  },
